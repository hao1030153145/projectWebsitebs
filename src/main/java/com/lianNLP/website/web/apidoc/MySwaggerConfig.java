 ...
 * @Package: com.lianNLP.website.web.swagger
 * <p>
 * Copyright (c) 2014-2017 Jeeframework Limited, Inc.
 * All rights reserved.
 */
package com.lianNLP.website.web.apidoc;
...
public class MySwaggerConfig extends AbstractSwaggerConfig {
    ...
    protected ApiInfo apiInfo() {
        return new ApiInfo("projectwebsitebs调用接口API", "projectwebsitebs applications and beyond!", "", "", "", "");
