...
public class ParseUtil {
    ...
    public static List<String> parseValue(String content,
        ...
        if (analysisType.equalsIgnoreCase("xpath")) {
            ...
            //固定值
            System.out.println("parseResult1    》》》》 parseValue 1：     "+ parseExpress);
            if (fixedJson != null && fixedJson.size() > 0) {
                ...
                if (!parseExpress.contains("return"))
                    parseExpress = "return " + parseExpress;
                System.out.println("parseResult1    》》》》parseValue 2：     "+ parseExpress);
                if (!parseExpress.endsWith(";"))
                    parseExpress += ";";
                System.out.println("parseResult1    》》》》parseValue 3：     "+ parseExpress);
                jsStr.append(parseExpress);
                System.out.println("parseResult1    》》》》parseValue 4：     "+ parseExpress);
                jsStr.append("}"); //commmentNum="评论数（12）";fixedJson.put("commentNum","评论数（12）")
                System.out.println("jsStr    》》》》1111111"+ jsStr);
                String jsResult = jsParse(jsStr.toString(), "processor");//function processor(){var commnetNum='评论数（12）'; return );}
                System.out.println("jsResult    》》》》2222222222"+ jsResult);
    ...
    public static String jsParse(String processorValue, String methodName) {
        System.out.println("jsStr    》》》》processorValue      "+ processorValue);
